...
public class AzureCORSPolicy extends AzurePolicy {
    ...
    public AzureCORSPolicy(CORSConfiguration corsConfiguration)
        ...
        this.setType(AzurePolicyType.CORS);
    ...
    private void readCORSPolicy(DocumentBuilder documentBuilder) throws APIManagementException {
        ...
        this.setRoot(document.getDocumentElement());
    }
    ...
    private void setCORSConfigurationToCORSPolicy(DocumentBuilder documentBuilder, CORSConfiguration corsConfiguration)
        ...
        // Allowed Origins
        Element allowOrigins = AzurePolicyUtil.firstElementByTagName(this.getRoot(),
        ...
        // Allowed Methods
        Element allowedMethods = AzurePolicyUtil.firstChildElementByTagName(this.getRoot(),
        ...
        // Allowed Headers
        Element allowedHeaders = AzurePolicyUtil.firstChildElementByTagName(this.getRoot(),
